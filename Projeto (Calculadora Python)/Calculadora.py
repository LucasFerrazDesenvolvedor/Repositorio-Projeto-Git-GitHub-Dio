...
#criando uma janela para a calculadora
janela = Tk()
janela.title("Calculadora")

#configurando largura e cumprimento da janela da calculadora
...
def entrar_valores(event):
    ...
    #passar o valor para aparecer na tela
...
#função para limpar a tela e mostrar o resultado ao termino do calculo
...
#criando botões para a calculadora
